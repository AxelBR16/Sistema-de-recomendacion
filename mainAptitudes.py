...
try:
    ...
    modelo = joblib.load('modelo_random_forest_aptitudes_optimizado.pkl')
    scaler = joblib.load('scaler_aptitudes.pkl')  # scaler que normalizó los datos de entrenamiento
