...
try:
    print("Cargando modelo k-NN y scaler...")
    modelo = joblib.load('modelo_knn_aptitudes_optimizado_smote.pkl')
...
async def obtener_recomendacion(data: RecomendacionRequest):
    try:
        ...
        prediccion = modelo.predict(datos_normalizados_df.values)  # usar .values para evitar warning
